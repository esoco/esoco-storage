...
public class FieldDescriptor extends RelatedObject {
	...
	FieldDescriptor(Field rField) {
		...
		if (sFieldName.equalsIgnoreCase("id")) {
			...
			if (rFieldType == int.class || rFieldType == Integer.class ||
				rFieldType == long.class || rFieldType == Long.class) {
	...
	public String toString() {
		return String.format("FieldDescriptor[%s,%s]", rField.getName(),
	...
	Object getFieldValue(Object rObject) {
		try {
			...
			throw new IllegalArgumentException(
				"Cannot access field " + rField.getName());
		}
	}
	...
	void setFieldValue(Object rObject, Object rValue) {
		try {
			...
			throw new IllegalArgumentException(
				"Cannot access field " + rField.getName(), e);
		}
	}
}

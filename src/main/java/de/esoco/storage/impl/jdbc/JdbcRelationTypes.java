...
public class JdbcRelationTypes {
	 ...
	 * it is set. This property will have precedence over a more generic
	 * storage
	 * name that may have been set as
	 * {@link StorageRelationTypes#STORAGE_NAME}.
	 */
	 ...
	 * the method
	 * {@link JdbcStorage#initObjectStorage(de.esoco.storage.StorageMapping)}.
	 */
	 ...
	 * identity datatype in CREATE TABLE statements. This is used by
	 * {@link JdbcStorage} when initializing the object storage. The default
	 * value is the standard SQL expression 'BIGINT AUTO_INCREMENT'.
	 */
	 ...
	 * by a query. If set it will be used for paging queries in conjunction
	 * with
	 * the relation {@link #SQL_QUERY_PAGING_EXPRESSION}.It must be
	 * parseable by
	 ...
	 */
	public static final RelationType<String> SQL_CHILD_COUNT_COLUMN =
		newType();
	 ...
	 * for {@link JdbcStorage#initObjectStorage(Class)}. If set the storage
	 * will
	 ...
	 * {@link RelationTypes#newType(org.obrel.core.RelationTypeModifier...)}
	 ...
	 * shortcut for annotating the relation type with {@link #SQL_NAME} but
	 * also
